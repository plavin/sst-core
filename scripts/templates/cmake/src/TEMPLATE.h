...
#ifndef {{ELEMENT_NAME_ALLCAPS}}
#define {{ELEMENT_NAME_ALLCAPS}}

#include <sst/core/component.h>

class {{COMPONENT_NAME}} : public SST::Component {

public:
/* SST ELI macros */
        /* Register component */
	SST_ELI_REGISTER_COMPONENT(
		{{COMPONENT_NAME}},                // Class name
		"{{ELEMENT_NAME}}",               // Name of library
		"{{COMPONENT_NAME}}",              // Lookup name for component
	...
	/* Class members */
	// Constructor
	{{COMPONENT_NAME}}( SST::ComponentId_t id, SST::Params& params );
